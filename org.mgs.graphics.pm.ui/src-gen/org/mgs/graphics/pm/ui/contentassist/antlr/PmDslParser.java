		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStageAccess().getGroup_6(), "rule__Stage__Group_6__0");
					...
					put(grammarAccess.getStageAccess().getWidthAssignment_3(), "rule__Stage__WidthAssignment_3");
					put(grammarAccess.getStageAccess().getHeightAssignment_5(), "rule__Stage__HeightAssignment_5");
					put(grammarAccess.getStageAccess().getDepthAssignment_6_1(), "rule__Stage__DepthAssignment_6_1");
					put(grammarAccess.getStageAccess().getDurationAssignment_7_1(), "rule__Stage__DurationAssignment_7_1");
					put(grammarAccess.getStageAccess().getFpsAssignment_7_3(), "rule__Stage__FpsAssignment_7_3");
					put(grammarAccess.getStageAccess().getOutputAssignment_9(), "rule__Stage__OutputAssignment_9");
