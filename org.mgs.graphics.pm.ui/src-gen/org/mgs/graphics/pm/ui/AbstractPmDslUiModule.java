...
/**
 * Manual modifications go to {org.mgs.graphics.pm.ui.PmDslUiModule}
 */
@SuppressWarnings("all")
public abstract class AbstractPmDslUiModule extends DefaultUiModule {
	
	public AbstractPmDslUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.LexerUIBindings.HIGHLIGHTING)).to(org.mgs.graphics.pm.parser.antlr.internal.InternalPmDslLexer.class);
	}
	...
	public Class<? extends org.eclipse.jface.viewers.ILabelProvider> bindILabelProvider() {
		return org.mgs.graphics.pm.ui.labeling.PmDslLabelProvider.class;
	}

	// contributed by org.eclipse.xtext.ui.generator.labeling.LabelProviderFragment
	public void configureResourceUIServiceLabelProvider(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.jface.viewers.ILabelProvider.class).annotatedWith(org.eclipse.xtext.ui.resource.ResourceServiceDescriptionLabelProvider.class).to(org.mgs.graphics.pm.ui.labeling.PmDslDescriptionLabelProvider.class);
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.outline.transformer.ISemanticModelTransformer> bindISemanticModelTransformer() {
		return org.mgs.graphics.pm.ui.outline.PmDslTransformer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.outline.actions.IContentOutlineNodeAdapterFactory> bindIContentOutlineNodeAdapterFactory() {
		return org.mgs.graphics.pm.ui.outline.PmDslOutlineNodeAdapterFactory.class;
	}

	// contributed by org.eclipse.xtext.ui.generator.quickfix.QuickfixProviderFragment
	public Class<? extends org.eclipse.xtext.ui.editor.quickfix.IssueResolutionProvider> bindIssueResolutionProvider() {
		return org.mgs.graphics.pm.ui.quickfix.PmDslQuickfixProvider.class;
	}

	// contributed by org.eclipse.xtext.ui.generator.contentAssist.JavaBasedContentAssistFragment
	public Class<? extends org.eclipse.xtext.ui.editor.contentassist.IContentProposalProvider> bindIContentProposalProvider() {
		return org.mgs.graphics.pm.ui.contentassist.PmDslProposalProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.contentassist.antlr.IContentAssistParser> bindIContentAssistParser() {
		return org.mgs.graphics.pm.ui.contentassist.antlr.PmDslParser.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexerProvider(com.google.inject.Binder binder) {
		binder.bind(org.mgs.graphics.pm.ui.contentassist.antlr.internal.InternalPmDslLexer.class).toProvider(org.eclipse.xtext.parser.antlr.LexerProvider.create(org.mgs.graphics.pm.ui.contentassist.antlr.internal.InternalPmDslLexer.class));
	}
